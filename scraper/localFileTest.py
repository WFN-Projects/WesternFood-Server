# testing the scrape method on local html file (run to check)
...
# test file
url = "localHTMLFiles/mplan-labiba.html"

# gets the html file and formats it into a nice, traversable string
# (when I was using a local file to test this, I couldn't use selenium lol)
